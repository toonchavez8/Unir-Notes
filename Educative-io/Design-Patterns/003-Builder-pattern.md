...
![Class Diagram](https://www.educative.io/api/collection/5307417243942912/5631943370604544/page/5723151296102400/image/6562123737989120?page_type=collection_lesson&collection_token=yAv07bzXFNWWIorIAXtnq7&get_optimised=true "Class Diagram")
...
In our hypothetical world, every aircraft requires at least the above three steps. However, a passenger aircraft can have an added step of making bathrooms in the plane. The steps represent the _**construction**_ process from our formal definition. The **_product_** is an aircraft but can have different **_representations_** such as an F-16 or a Boeing-747. Using the same construction process, we should be able to produce both F-16s and Boeings.
