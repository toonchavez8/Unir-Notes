...
- Aprender a analizar el riesgo de un sistema y mitigarlo por fases.
...
Se recomienda descargar el manual de usuario de la herramienta PILAR disponible en el enlace provisto en el apartado «Pautas de elaboración». Se recomienda leerlo antes de hacer el ejercicio e instalar la aplicación según las instrucciones de la página.

- Ejecutar el fichero de instalación pilar_<version>_<lang>.exe con usuario administrador.
    - Aceptar las condiciones de uso.
    - Seguir las instrucciones para instalar en el directorio que se prefiera (varios idiomas pueden compartir el mismo directorio de instalación).

Descarga: [https://www.pilar-tools.com/es/tools/](https://www.pilar-tools.com/es/tools/) (versión RM-ENS).

Al arrancar la herramienta seleccionar **licencia de evaluación.**

Tener en cuenta que la licencia **no permite imprimir resultados,** por lo que habrá que sacar la información mediante capturas de pantalla.

Seleccionar en el menú **Nivel > Básico:**

![mexissi05_act1](<Maestría-Ingeniería-de-Software/04-CiberSeguridad-web/Actividades/Actividad-01/Attachments/mexissi05_act1%202.jpeg>)

Figura 3. Herramienta PILAR nivel básico. Fuente: elaboración propia.

En la siguiente pantalla, crear un proyecto y empezar a trabajar:

![mexissi05_act1](<Maestría-Ingeniería-de-Software/04-CiberSeguridad-web/Actividades/Actividad-01/Attachments/mexissi05_act1%203.jpeg>)

Figura 4. Herramienta PILAR: Nuevo proyecto. Fuente: elaboración propia.

Si necesitas ayuda, accede a manuales de consulta a través de los siguientes enlaces: [https://www.ar-tools.com/doc/manual_rm_es_20221.pdf](https://www.ar-tools.com/doc/manual_rm_es_20221.pdf) y [https://www.ar-tools.com/doc/help_rm_es_e_20221.pdf](https://www.ar-tools.com/doc/help_rm_es_e_20221.pdf)
