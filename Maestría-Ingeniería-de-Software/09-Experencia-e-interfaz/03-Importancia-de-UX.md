...
```mermaid
graph TD
A[UX] --> B[Perspectiva Profesional]
A --> C[Perspectiva Social]
A --> D[Perspectiva Negocio]

B --> E[Diseño de Interfaces]
C --> F[Impacto en Usuarios]
D --> G[Resultados Económicos]

E --> H[Errores si no hay investigación]
F --> I[Riesgos en salud y vida]
G --> J[Incremento de métricas]
```
