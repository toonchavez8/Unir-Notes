...
Debido a que la liga original de UNIR Dev no se encuentra disponible, se utiliza **Microsoft Learn** como plataforma de referencia para el análisis. Esta plataforma presenta características similares al propósito de UNIR Dev, como rutas formativas, módulos, contenidos tecnológicos, navegación por temas y recursos dirigidos a estudiantes, desarrolladores y profesionistas de TI.

> [!NOTE]
> Microsoft Learn se usa como referencia UX/UI, no como modelo visual para copiar. El objetivo es analizar cómo organiza la información y cómo guía al usuario.
...
## 2.1 Análisis de Microsoft Learn como referencia
...
Para UNIR Dev, estos elementos se adaptan como rutas de aprendizaje, categorías tecnológicas, recursos educativos, tendencias, marketplace y perfiles de usuario con favoritos.

> [!TIP]
> Esta sección puede colocarse después del contexto del proyecto porque justifica por qué Microsoft Learn es una referencia válida antes de presentar el brief.
...
### 3.7 Alcance inicial de la plataforma
...
> [!IMPORTANT]
> Se recomienda dejar comunidad, foros, certificaciones y comparadores avanzados como una segunda fase. Esto ayuda a que el alcance inicial sea viable y fácil de justificar.
...
La propuesta parte de los siguientes supuestos:
...
- La cantidad de contenido crecerá con el tiempo, por lo que la arquitectura debe ser escalable.
...
- Los proveedores tienen una ficha clara con acciones de contacto visibles.
- Los wireframes representan las pantallas principales de la experiencia.
...
**Necesidad en UNIR Dev:** perfil de proveedor, catálogo de servicios y acciones de contacto visibles.
...
> [!NOTE]
> La estructura toma como referencia la lógica de Microsoft Learn: rutas, módulos, contenidos recientes y exploración por temas, pero la adapta al caso de UNIR Dev.
...
Este flujo facilita la exploración de tecnologías actuales y permite revisar contenidos relacionados con una necesidad profesional.
...
> [!TODO]
> Falta integrar los wireframes finales como imágenes o capturas. Se recomienda colocarlos en esta sección y explicar debajo de cada uno qué necesidad resuelve.
...
```text
+----------------------------------------------------+
| Logo UNIR Dev | Inicio | Rutas | Recursos | Perfil |
+----------------------------------------------------+
| Busca recursos, herramientas o servicios            |
...
| [Recurso] [Curso] [Servicio]                        |
+----------------------------------------------------+
```

> [!TIP]
> Aquí conviene insertar el primer wireframe visual hecho en Figma, Canva, PowerPoint o Draw.io.
...
```text
+----------------------------------------------------+
| Logo UNIR Dev | Menú principal | Perfil             |
+----------------------------------------------------+
| Resultados para: Desarrollo web                     |
+-------------------+--------------------------------+
| Filtros           | Resultados                      |
| - Guías           | [Tarjeta: guía de HTML/CSS]     |
| - Herramientas    | [Tarjeta: curso de React]       |
| - Servicios       | [Tarjeta: proveedor frontend]   |
| - Nivel           |                                |
+-------------------+--------------------------------+
```
...
> [!TODO]
> Agregar un wireframe visual para esta pantalla si se quiere reforzar la relación con Microsoft Learn.

### 8.5 Pantalla de contacto, registro o solicitud de información

**Objetivo de la pantalla:** permitir que estudiantes, profesionistas o proveedores soliciten información, registren interés o contacten a un proveedor.
...
> [!IMPORTANT]
> Esta pantalla ayuda a cerrar el flujo de proveedores y usuarios interesados. Si no se incluye, la propuesta queda incompleta porque no hay acción final de contacto.
...
> [!TODO]
> Antes de entregar, integra los wireframes visuales finales y revisa que la portada tenga docente y fecha de entrega.
